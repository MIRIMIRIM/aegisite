...
This was originally used mainly for creating [karaoke effects](/docs/karaoke-effect/), but over time it has expanded in scope to support more general purpose [macros](/docs/macro/) which add arbitrary new functionaly to Aegisub.
...
This includes the advanced **[Karaoke_Templater](/docs/karaoke-templater/)** script and a **[collection of macros](/docs/standard-macros/)** to simplify some editing tasks.

Aegisub almost always has several Automation scripts loaded at a time.
You can see what scripts are loaded, and load/unload more from the **[Automation/Manager](/docs/automation-manager/)** window.

All Automation scripts also present themselves in Aegisub in one way or another.
Some appear as [macros in the Automation menu](/docs/running-macros/) and others appear as [filters in the Export dialog](/docs/exporting-subtitles/).
