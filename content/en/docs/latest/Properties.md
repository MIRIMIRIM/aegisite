...
- **Resolution**, **YCbCr Matrix**, **Scale border and shadow** - See the [Script Resolution](/docs/script-resolution/) page for the meaning of these fields.
...
Mode two is sometimes useful for long lines which are scrolled or manually line-broken, but should be set on a per-line basis with the [\\q](/docs/ass-override-tags/#\\q/) tag.
