...
The Resolution Resampler is a built-in tool designed to change the [resolution of the script](/docs/script-resolution/) while transforming all affected tags so it
