...
right-click menu (see [editing subtitles](/docs/editing-subtitles/)).
...
dictionaries. You may need to set the [dictionary path](/docs/aegisub-options/#interface/) to the location where they are installed; one
