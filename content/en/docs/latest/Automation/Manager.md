...
[Automation](/docs/automation-overview/) scripts.
...
[features](/docs/automation-script-feature/), for example one script file
can define two [macros](/docs/macro/) and one export filter.
...
- When the [Export](/docs/exporting-subtitles/) dialog is opened all local scripts are
  reloaded. You can change this in the [Options](/docs/aegisub-options/#automation/)
  dialog.
...
- While there is no default hotkey to reload all scripts, you can add one in
  the [preferences dialog](/docs/aegisub-options/#hotkeys/).
