...
are available in the code line/block execution environment see: [Code execution environment](/docs/execution-environment/).
...
used to insert more complex things than can be expressed with [inline variables](/docs/inline-variables-variables/).
