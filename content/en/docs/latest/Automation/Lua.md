...
[Automation/Manager](/docs/automation-manager/) window: `script_name`, `script_description`,
...
**[Registration](/docs/registration/)** page. The only fields of the
...
dialogue lines and comment lines. This is described on the **[Subtitle file interface](/docs/subtitles-object/)** page.
...
outside the core API as [Lua modules](/docs/lua-modules/). While it is possible to write
