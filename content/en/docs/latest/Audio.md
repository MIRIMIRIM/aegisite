...
can open any type of audio file that your [audio provider](/docs/aegisub-options/#advancedaudio/) can decode (more on this below). In
...
playing audio results in no sound, switching to a [different audio player](/docs/aegisub-options/#advancedaudio/) may help.
...
the audio is downmixed to mono (see the [audio downmixer option](/docs/aegisub-options/#avisynth-windows-only/) if you want to grab one channel only
...
if you're working with a full-length movie, refer to the [audio cache option](/docs/aegisub-options/#cache/) for instructions on how to make Aegisub use its
