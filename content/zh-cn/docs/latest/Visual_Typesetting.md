...
**关于这个功能，你能在 [视频教程](/zh-cn/docs/教程/)中找到。**
...
播放视频, 从当前帧开始。查看
[使用视频](/zh-cn/docs/视频/#playingvideo/) 来获取Aegisub中有关的信息。
...
[\\t](/zh-cn/docs/ass标签/#animatedtransform/) 和
[\\fad](/zh-cn/docs/ass标签/#fade/)。
...
[\\pos 标签](/zh-cn/docs/ass标签/#setposition/)
...
[\\pos](/zh-cn/docs/ass标签/#setposition/) 参数会被写入到行中。
...
[\\org](/zh-cn/docs/ass标签/#rotationorigin/)
标签)，或者你随意点击来确定旋转的角度。
