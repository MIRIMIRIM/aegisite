...
原本主要用于创作[卡拉OK特效](/zh-cn/docs/卡拉ok特效/)，但随着时间推移，用法也变得多样，支持更多的通用[宏](/zh-cn/docs/宏/)来向Aegisub添加新的功能。
...
**[Karaoke Templater](/zh-cn/docs/卡拉ok模版执行器/)** 脚本和
**[几个宏操作(collection of macros)](/zh-cn/docs/附带的宏/)**
来简化一些编辑任务。

Aegisub通常是一次加载多个脚本。您能从\*\*[自动化脚本管理器](/zh-cn/docs/自动化脚本管理器/)\*\*
中看到加载了哪些脚本，或者加载、移除更多的脚本。

所有的自动化脚本都有显现在Aegisub里的方式。一些[以宏的形式出现在自动化菜单](/zh-cn/docs/运行宏/)中，一些作为[导出时的滤镜](/zh-cn/docs/导出/)，
一些脚本在这两处都出现。
