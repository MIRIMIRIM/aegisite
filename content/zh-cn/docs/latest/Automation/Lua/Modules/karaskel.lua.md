...
`karaskel.lua` 包含 [`utils.lua`](/zh-cn/docs/utils-lua/) 和
[`unicode.lua`](/zh-cn/docs/unicode-lua/)
...
- `line.kara` 和 `line.furi` - 扩展版的
  [卡拉OK和假名标注表](/zh-cn/docs/karaskel-lua/#karaoke-and-furigana-syllable-tables/),
  不含尺寸位置信息。
...
详见这部分 [data structures](/zh-cn/docs/karaskel-lua/#datastructures/) 。
