...
[卡拉OK特效](/zh-cn/docs/karaoke-effect/)。在一系列教程里，我们由简单到复杂来进行教学。
...
[Karaoke Timing Tutorial](/zh-cn/docs/karaoke-timing-tutorial/)
...
[ASS特效标签](/zh-cn/docs/ass-override-tags/)
，发挥想象，会有更丰富的效果。

你也可以
[继续下一篇教程](/zh-cn/docs/using-math-expressions/)，在那里你可以了解如何对变量做一些数学上的调整，来获取一些变型。
