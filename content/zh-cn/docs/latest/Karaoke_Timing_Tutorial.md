...
本部分参见 [制作时间轴](/zh-cn/docs/timing-subtitles-to-audio/)
...
如果有兴趣继续学习，请查看[卡拉OK模板](/zh-cn/docs/karaoke-templater/)部分，这部分讲述了如何制作较为复杂的卡拉OK效果
