...
脚本分辨率可以简单地在 [脚本配置](/zh-cn/docs/script-properties/)
对话框中修改，或者使用 [重设分辨率](/zh-cn/docs/resolution-resampler/)
工具。 用哪个取决于你缘何修改脚本分辨率。
如果你目前有一个未设置样式的字幕脚本，这个脚本因为某些原因分辨率设置错误，这种情况下使用
[脚本配置](/zh-cn/docs/script-properties/) 进行修改。
...
"重设脚本分辨率" 按照 [重设分辨率](/zh-cn/docs/resolution-resampler/)
