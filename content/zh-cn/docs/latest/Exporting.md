...
滤镜通过自动化脚本
"卡拉OK模板"生成卡拉OK特效。详见[卡拉OK模板](/zh-cn/docs/卡拉ok模版执行器/)
和 [自动化](/zh-cn/docs/自动化/) 。

### 帧率转换

在"固定"
输出模式下，以新的帧率重新计算脚本内的每一个时间标记(包含特效标签中的[\\k](/zh-cn/docs/ass标签/))。
...
详见 [可变帧率视频](/zh-cn/docs/视频/#variableframeratevideo/) 。
