...
<div class="alert alert-warning" role="alert"><strong>TODO: </strong>Video pendiente</div>
...
- [Sincronizar karaoke](/docs/karaoke-timing-tutorial/) (en construcción) — Ingresar la letra de una canción y agregarle cógigos de tiempo.
- [Tutorial de efectos karaoke incorporados](/docs/inline-effects-tutorial/)
- [Tutorial Karaoke Furigana](/docs/furigana-tutorial/)
- [Plantillas de karaoke](/docs/karaoke-templater/) (incomplete) — Manera fácil de agregar efectos especiales a karaoke, desde los más básicos hasta los muy avanzados.
